package it.gov.pagopa.atmlayer.service.userservice.exception;
...
import static it.gov.pagopa.atmlayer.service.userservice.enums.AppErrorCodeEnum.ATML_USER_SERVICE_500;
...
public class AtmLayerException extends WebApplicationException {
    ...
    public AtmLayerException(Throwable error) {
        ...
        this.type = ATML_USER_SERVICE_500.getType().name();
        this.statusCode = 500;
        this.errorCode = ATML_USER_SERVICE_500.getErrorCode();
    }
